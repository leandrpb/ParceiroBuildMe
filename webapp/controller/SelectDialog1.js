sap.ui.define([
	...
	return ManagedObject.extend("com.sap.build.standard.prototipoParceiros.controller.SelectDialog1", {
		constructor: function(oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "com.sap.build.standard.prototipoParceiros.view.SelectDialog1", this);
			this._bInit = false;
		},
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "sap_m_SelectDialog_0",
				"groups": ["items"]
			}];
