sap.ui.define([
	...
	return ManagedObject.extend("com.sap.build.standard.prototipoParceiros.controller.SelectDialog2", {
		constructor: function(oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "com.sap.build.standard.prototipoParceiros.view.SelectDialog2", this);
			this._bInit = false;
		},
		...
		_onSelectDialogLiveChange: function(oEvent) {
			var sControlId = "sap_m_SelectDialog_0-E1_1688674736677";
			...
			return new Promise(function(fnResolve) {
				...
				if (sQuery && sQuery.length > 0) {
					...
					aFilters.push(new sap.ui.model.Filter("Tipo", sap.ui.model.FilterOperator.Contains, sQuery));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "sap_m_SelectDialog_0-E1_1688674736677",
				"groups": ["items"]
			}];
